"""
EXTRACTED FROM : https://labrosa.ee.columbia.edu/millionsong/sites/default/files/tutorial1.py.txt
...
def apply_to_all_files(basedir, all_data, func=lambda x,y,z: 0, ext='.h5'):
    """
